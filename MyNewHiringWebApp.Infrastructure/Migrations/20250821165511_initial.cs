        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Resume_Summary = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Resume_GithubUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Resume_LinkedInUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CandidateSkill_Level", "[Level] BETWEEN 1 AND 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestSubmissions_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubmittedAnswers_TestSubmissions_TestSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_CandidateId_JobPositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPositions_Title_DepartmentId",
                table: "JobPositions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubmittedAnswers_TestSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestSubmissions_CandidateId",
